...
from inspections.models import FollowedRestaurant, RestaurantInspection, RestaurantNotification
    ...
    def handle(self, *args, **options):
        ...
        for followed in followed_restaurants:
            try:
                ...
                if (followed.notify_grade_changes and 
                    followed.last_known_grade != latest_inspection.GRADE and
                ...
                if (followed.notify_new_inspections and
                    latest_inspection.INSPECTION_DATE > (followed.last_inspection_date or datetime.min.date())):
