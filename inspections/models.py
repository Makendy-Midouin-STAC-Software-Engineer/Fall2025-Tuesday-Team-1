...
class RestaurantInspection(models.Model):
    ...
    def get_restaurant_rating(cls, camis):
        ...
        ).exclude(INSPECTION_DATE__year=1900)  # Exclude invalid dates
...
class RestaurantDetails(models.Model):
    ...
    phone_formatted = models.CharField(max_length=20, blank=True, null=True)  # Better formatted phone
    
    # Hours of Operation
    monday_hours = models.CharField(max_length=50, blank=True, null=True, help_text="e.g., '9:00 AM - 10:00 PM' or 'Closed'")
    ...
    menu_highlights = models.TextField(blank=True, null=True, help_text="Popular dishes, specialties")
    price_range = models.CharField(max_length=20, blank=True, null=True, help_text="e.g., '$', '$$', '$$$', '$$$$'")
    delivery_available = models.BooleanField(default=False)
    takeout_available = models.BooleanField(default=True)
    reservations_accepted = models.BooleanField(default=False)
    
    # Additional Details
    description = models.TextField(blank=True, null=True, help_text="Restaurant description/about")
    special_features = models.TextField(blank=True, null=True, help_text="Outdoor seating, live music, etc.")
    parking_info = models.CharField(max_length=200, blank=True, null=True)
    
    # Management fields
    created_date = models.DateTimeField(auto_now_add=True)
    updated_date = models.DateTimeField(auto_now=True)
    is_verified = models.BooleanField(default=False)  # For verified business information
